  ...
  <div class="row<?php if(!$auth){ echo " hidden"; } ?>">
    ...
    <div class="col-sm-4 pt-1 pt-md-0">
      <div class="card shadow-sm">
        ...
        <div class="card-body">
          <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" class="btn btn-outline-primary mt-1" disabled><i class="bi bi-power"></i>&nbsp;Power</button>&nbsp;
          <button type="button" onclick="logout()" class="btn btn-outline-warning mt-1" disabled><i class="bi bi-arrow-right-square"></i>&nbsp;Logout</button>
        </div>
      </div>
    </div>
  </div>
